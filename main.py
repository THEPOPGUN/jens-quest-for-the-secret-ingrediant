def on_up_pressed():
    animation.run_image_animation(Jen,
        [img("""
                . . . . . . f f f f . . . . . . 
                        . . . . f f e e e e f f . . . . 
                        . . . f e e e f f e e e f . . . 
...
def on_a_pressed():
    ...
    Jen = sprites.create(img("""
        ...
        """),
        SpriteKind.player)
    controller.player1.move_sprite(Jen)
    scene.camera_follow_sprite(Jen)
...
def on_overlap_tile2(sprite2, location2):
    ...
    scene.set_background_image(img("""
        ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                ...
                fffffffffffffffffffffffffffff1fffffffffffffffffffffffffffffffffff11fff111fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff1ffff1ffffffffff
                ...
                ffffffffffffffffffffffffffffffffffffffffff1ffffffffffffffffffff11fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff
                ...
                
    ...
    Boss.set_position(100, 60)
    
    def on_start_cutscene2():
        story.sprite_say_text(Jen, "I'm here for my shift.")
        pause(200)
        story.sprite_say_text(Boss, "Not now Jen, were making soup.")
        pause(200)
        story.sprite_say_text(Jen, "I like soup, what kind?")
        pause(200)
        story.sprite_say_text(Boss, "Thats the thing, we dont know.")
        pause(200)
        story.sprite_say_text(Boss, "We need a secret Ingrediant.")
        pause(200)
        story.show_player_choices("What about Banana?", "You need some Milk?", "Bread?")
        pause(200)
        story.sprite_say_text(Boss, "Wait, YES! Thats it!")
        pause(200)
        story.sprite_say_text(Jen, "I knew it would be.")
        pause(200)
        story.sprite_say_text(Boss,
            "Well I have none on me, but if you can get to my house,")
        pause(200)
        story.sprite_say_text(Boss, "I might just save you a bowl.")
        pause(100)
